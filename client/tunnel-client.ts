/**
 * WebSocket-based HTTP tunnel client — the embeddable library.
 *
 * Connects to the relay via WebSocket, receives HTTP requests, forwards them to
 * a local port, and streams responses back. Also bridges browser WebSocket
 * upgrades to the local server. The CLI (`bin`) lives in ./cli.ts.
 */
...
export const DEFAULT_HOST = 'https://volter-tunnel.relay.internal.example';
