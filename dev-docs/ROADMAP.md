...
free, stable, reservable tunnel ID). The free tier is built and deployed on `voltertest.xyz` (signup, reserved IDs, idle reclaim, the inspector and
replay), and bandwidth and concurrency tiers are per-account configuration; the
